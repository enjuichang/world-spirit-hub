...
export const categoryGuides: CategoryGuide[] = [
  {
    ...
    labelTerms: [
      ...
      { term: "Australian Whisky", place: "Australia", meaning: "Australian-made cereal-grain spirit matured in wood for at least two years before release from excise control.", region: { name: "Australia", point: [134, -25], kind: "traditional" } },
    ],
    subtypes: [
      ...
      { name: "Australian whisky", lawStatus: "Broad style", law: "Australian whisky is distilled from a fermented cereal-grain mash and must mature in wood for at least two years before it can be released from excise control. The name does not prescribe one grain recipe, still type or regional style.", style: "Often malt-led and small-batch, spanning bright orchard fruit and cereal through wine-cask richness, spice, smoke and concentrated warm-climate oak.", region: { name: "Australia", point: [134, -25], kind: "traditional" } },
  ...
  },
  {
    ...
    labelTerms: [
      ...
      { term: "Calvados", place: "Normandy, France", meaning: "Protected cider or perry spirit from defined Norman areas.", region: { name: "Calvados", point: [-0.41, 48.96], kind: "protected" } },
    ...
    subtypes: [
      ...
      { name: "Brandy de Jerez", lawStatus: "Protected origin", law: "Spanish GI produced and aged exclusively in Jerez de la Frontera, El Puerto de Santa María and Sanlúcar de Barrameda, typically using a criaderas y solera system.", style: "Rich, rounded and cask-led, with dried fruit, walnut and sweet spice from seasoned Sherry casks.", region: { name: "Jerez", mapLabel: "Brandy de Jerez area", point: [-5.95, 36.7], kind: "protected" } },
...
export const guideSources = [
  ...
  { label: "Australian Excise Act whisky requirements", url: "https://www.legislation.gov.au/C1901A00009/latest/text" },
